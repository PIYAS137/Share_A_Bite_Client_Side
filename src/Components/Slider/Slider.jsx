...
const Slider = () => {
  return (
    ...
    <div id="slide2" className="carousel-item relative w-full max-h-[700px] rounded-xl overflow-hidden">
        <img src='https://i.ibb.co/5YWZMhf/wallpaperflare-com-wallpaper-28.jpg' className="w-full object-cover" />
        <div className="p-16 flex flex-col justify-center absolute left-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0.00)] h-full w-full">
            <div className=' text-white'>
                <h1 className='mb-4 text-6xl font-extrabold max-w-[35%]'>Affordable Price For Car Servicing</h1>
                <p className='font-semibold text-lg mb-5'>There are many variations of passages of  available, but <br /> the majority have suffered alteration in some form</p>
                <div className=''>
